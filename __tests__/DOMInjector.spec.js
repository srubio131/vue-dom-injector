...
describe('Private methods', () => {
    ...
    describe('_addExtraAttrsToNode()', () => {
        ...
        test('Add extra attrs to html node', () => {
            node = $domInjector._addExtraAttrsToNode(node, { type: 'text/javascript' })
    ...
    describe('_createNode()', () => {
        ...
        test('Create new node from string and with attrs', () => {
            const newNode = $domInjector._createNode(scriptString, { type: 'text/javascript' })
            expect(newNode).not.toBeNull()
...
describe('Public methods', () => {
    ...
    describe('injectNode()', () => {
        ...
        test('inject node with custom parameters', () => {
            ...
            return $domInjector
                .injectNode(scriptString, params)
                .then(node => {
    ...
    describe('removeNode()', () => {
        ...
        test('remove node by id (succesfully)', () => {
            return $domInjector
                .removeNode('#test')
                .then (() => {
                    setTimeout(() => { // Wait to document refresh
        ...
        test('remove node (error)', () => {
            ...
            return $domInjector.removeNode().catch((e) => {
                expect(e).toMatch("To delete a node it's necessary to indicate a selector")
            })
        })
    })
})
